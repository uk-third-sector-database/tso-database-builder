...
linkages between organisations which appear in more than one register. The dataset is available at the project website\footnote{\url{https://uk-third-sector-database.io/}}.

Ten data sources are combined in order to build the organisational spine, listed in Table \ref{tab:order}, and further detailed in appendices. 
