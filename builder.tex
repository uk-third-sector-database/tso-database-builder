...
\begin{figure}[h]
  ...
  \begin{tabularx}{0.8\textwidth}{|X|r|r|r|}
    \hline
    source & count in spine & count of matches & count of matches not in spine \\
    \hline
    CHC & 337858 & 73308 & 4132 \\\hline
    SC & 49306 & 10172 & 1346 \\\hline
    NIC & 7746 & 659 & 0 \\\hline
    COH & 362311 & 87023 & 74229 \\\hline
    COOP & 9239 & 9978 & 1323 \\\hline
    MPR & 18649 & 13036 & 13024 \\\hline
    SHR & 158 & 15 & 0 \\\hline
    SHPE & 9 & 1311 & 1311 \\\hline
    CIS & 0 & 1882 & 1882 \\\hline
    CQC & 0 & 975 & 975 \\\hline
    \hline
\end{tabularx}
...
used. 
\subsubsection{Notes}
For   a   subset   of   charity   numbers,   these   data   contain   multiple   dates   of   registration   and/or
...
The OSCR data used in this project comprised six individual data files that were obtained
between 2012 and 2023. These files were used to compile a list of unique charities, and to
extract   as   many   unique   names,   addresses,   registration   dates,   and   removal   dates   for   each
organisation. These files are detailed below: 
\begin{itemize}
...
The CCNI data used in this project comprised one open data file obtained in April 
2023\footnote{ccni-charity-register-2023-04-19.xlsx [CCNI charity register - 19 April 2023]}. This
file was used to compile a list of unique charities with accompanying names, addresses, and
...
(e.g., S\'{o}l\'{a}s in Belfast operates under the charity number 100114). As such, we did not need to
de-duplicate the CCNI data. This dataset is later merged with data from all other data sources.

The codebook of variables is found in Table \ref{tab:ccni_preprocess}.

\subsubsection{Limitations}
Unlike the other charity regulator data sources, our data for CCNI does not provide multiple
unique names, addresses, or registration dates. This information can be gathered going forward
by updating the data periodically with the most recent CCNI open data download. However, at
this point in time, the CCNI data is less comprehensive than its counterparts in England, Wales,
...
Finally, there are 17 CCNI organisations for which the data does not provide valid postcodes.
These observations are kept in the final dataset because we do have information on charity
names, registrations dates, and street addresses. 
...
\clearpage
\subsection{Overview of charity regulator data}
\begin{table}[h]
  \centering
  \begin{tabularx}{\textwidth}{|X|l|l|l|l|}
    \hline
&CCEW&OSCR&CCNI&Total \\ \hline \hline
Unique organisations & 341,990 & 50,652 & 7,746 & 400,388\\ \hline
Unique names & 545,091 & 61,124 & 7,746 & 613,966\\ \hline
Unique addresses & 668,888 & 53,612 & 7,746 & 730,517\\ \hline
Unique registration dates & 357,631 & 50,655 & 7,746 & 416,032\\ \hline
Unique removal dates & 182,703 & 25,262 & 0 & 207,965\\ \hline
\end{tabularx}
\caption{Overview of charity regulator data}
\label{tab:char_regulator_inputs}
\end{table}
...
Using bulk downloads alone would only mean organisations that were dissolved earlier than 2023 would 
not be present in the database. Using the Companies House API
we found all companies registered and dissolved which fit our inclusion criteria (in particular the 
company type, see table \ref{tab:CH_companytypes}). The code used to search the API is found in our 
github repository 
\url{https://github.com/uk-third-sector-database/ch_adv_scraper}. Previous work by members of our team 
identified charitible organisations in companies house data during the period ......  
...
Each of the three companies house data sources were pre-processed to identify primary name and address for each 
included organisation, with any alternative names and addresses also stored. The three sources were then 
...
This process led to a total of 436,540 organisations from companies house, of which 197,517 
had supplementary/additional information. 
...
\begin{table}[h]
  \begin{tabularx}{\textwidth}{|X|r|}
    \hline
    Company Type (alphabeticalised) & Count of organisations \\ \hline
    \hline
    CLG                                                                                        &  189348 \\ \hline
    Charitable Incorporated Organisation                                                       &  346682 \\ \hline
    Community Interest Company                                                                 &  358012 \\ \hline
    Industrial and Provident Society                                                           &   15366 \\ \hline
    PRI/LBG/NSC (Private, Limited by guarantee, no share capital, use of 'Limited' exemption)  &  436013 \\ \hline
    PRI/LTD BY GUAR/NSC (Private, limited by guarantee, no share capital)                      & 1212152 \\ \hline
    Registered Society                                                                         &  105512 \\ \hline
    Scottish Charitable Incorporated Organisation                                              &   63394 \\ \hline
    ltd community-interest-company                                                             &    9343 \\ \hline
    plc community-interest-company                                                             &       2 \\ \hline
    private-limited-guarant-nsc                                                                &  193501 \\ \hline
    private-limited-guarant-nsc community-interest-company                                     &   82326 \\ \hline
    private-limited-guarant-nsc-limited-exemption                                              &   67796 \\ \hline
    private-limited-guarant-nsc-limited-exemption community-interest-company                   &     102 \\ \hline

\hline
  \end{tabularx}
  \caption{Distribution of company types in dataset.}
  \label{tab:CH_types_dist}
\end{table}

Compressing these categories such that all Community Interest Companies are grouped, and all remaining companies which are
...
\begin{table}[h]
  ...
  \begin{tabularx}{0.8\textwidth}{|X|r|}
    ...
    \hline
Charitable Incorporated Organisation          &    346682\\ \hline
Community Interest Company                    &    449785\\ \hline
Company Limited by Guarantee                  &   2098810\\ \hline
Industrial and Provident Society              &     15366\\ \hline
Registered Society                            &    105512\\ \hline
Scottish Charitable Incorporated Organisation &     63394\\ \hline
\end{tabularx}
...
This process yeilds 10562 unique organisations, of which 8675 had additional
 information in the supplementary csv.
...
This process yeilds 31673 unique organisations, of which 475 had additional information in the supplementary csv.
...
This process yeilds 158 unique organisations.
...
This process yeilds 1320 unique organisations.
...
This process yeilds 3464 unique organisations, of which 3146 had additional information in the supplementary csv
...
This process yeilds 36629 unique organisations, of which 27406 had additional information in the supplementary csv
