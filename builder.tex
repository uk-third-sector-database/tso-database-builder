...
Using bulk downloads alone would only mean organisations that were dissolved earlier than 2023 would not be present in the database. However the companies house API allows for detailed searching of the data, so we used 
this to find any companies registered and dissolved which fit our inclusion criteria (in particular the company type, see table \ref{tab:CH_companytypes}). The code used to search the API is found in our github repository 
