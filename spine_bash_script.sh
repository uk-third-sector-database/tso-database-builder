...
#python3 cli.py sub-spine CompaniesHouse ../raw_data/BasicCompanyDataAsOneFile-2023-06-01.csv ../spine_data/CH_June_2023.spine.csv
python3 cli.py sub-spine CompaniesHouse ../raw_data/BasicCompanyDataAsOneFile-2023-10-04.csv ../spine_data/CH_Oct_2023.spine.csv
python3 cli.py sub-spine CompaniesHouse2014 ../raw_data/soton14reduced.csv ../spine_data/CH_2014.spine.csv
python3 cli.py sub-spine CompaniesHouseGapDecade ../raw_data/ch_adv_scrape.csv ../spine_data/CH_gap_decade.spine.csv
#
#
## Care Inspectorate Scotland files: 
for i in ../raw_data/CareInspectScot/MDSF_data_*
do
  python3 cli.py sub-spine CareInspScot "$i" $i.spine.csv
done
mv ../raw_data/CareInspectScot/*spine.csv ../spine_data/
#
#
## Care Quality Commission:
python3 cli.py sub-spine CQC ../raw_data/CareQualityCommission/25_January_2023_CQC_directory__.csv ../spine_data/CQC_Jan_2023.spine.csv
#
#
## Co Ops & Mutuals:
python3 cli.py sub-spine CoOps ../raw_data/co_ops.open_data_orgs_2022_q2.csv ../spine_data/CoOps_2022.spine.csv
python3 cli.py sub-spine Mutuals ../raw_data/mutuals-spine-2023-06-07.csv ../spine_data/mutuals.spine.csv
#
## Social Housing England:
python3 cli.py sub-spine SocialHousingEng ../raw_data/SocialHousingEngland_202301016.csv ../spine_data/SocialHousingEngland_2023.spine.csv
#
#
## Scottish Housing Regulator:
for i in ../raw_data/ScotHousingReg/afs-data-all-social-landlords-complete-dataset-20*
do
  python3 cli.py sub-spine ScotHousingReg $i $i.spine.csv
done
mv ../raw_data/ScotHousingReg/*spine.csv ../spine_data/
#
## Charity regulators:
python3 cli.py sub-spine CCEW ../raw_data/ccew_spine.csv ../spine_data/ccew.spine.csv
python3 cli.py sub-spine CCNI ../raw_data/ccni_spine.csv ../spine_data/ccni.spine.csv
python3 cli.py sub-spine OSCR ../raw_data/oscr_spine.csv ../spine_data/oscr.spine.csv
